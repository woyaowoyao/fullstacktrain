...
<head>
<meta charset="UTF-8">
<title>Lab05 Training - Login</title>
...
<body class="login-page">
	<div class="container">
		<form class="form-signin" method="post" action="${ctx }/login">
		    <h2 class="form-signin-heading">Lab05 Training</h2>
			...
			<p class="d-flex mt-5">
	            ...
	            <div class="float-right text-light">No account? <a class="text-warning" href="${ctx }/register">Register.</a></div>
            </p>
		</form>
	</div>
</body>
